...
class ejecucion_finpi extends CI_Controller{
  ...
  public function cumplimiento_trimestre($dep_id,$tp){
    ...
    if(count($ppto_ejec_trimestre)!=0){
      ...
      if(count($ppto_prog_trimestre)!=0 & ($ppto_prog_trimestre[0]['monto']!=0 || $ppto_prog_trimestre[0]['monto']!='')){
     ...
     <table class="table table-bordered" style="width:90%;">
        <thead>
          <tr>
            ...
            <th style="width:5%;"><b>TOTAL EJECUTADO</b></th>
          </tr>
        </thead>
        <tbody>
          <tr>
         ...
         /*   <td align=right>'.number_format($detalle_modificacion_pi[1], 2, ',', '.').'</td>
          ...
          $tabla.='
            ';
            for ($i=0; $i <=12 ; $i++) { 
              $tabla.='<td align=right><b>'.number_format($ppto_pi[$i], 2, ',', '.').'</b></td>';
            }
          $tabla.='
          </tr>
        </tbody>
