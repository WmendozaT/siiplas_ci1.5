...
class Genera_informacion extends CI_Controller{
    ...
    /*-- REPORTE 2 (CONSOLIDADO FORMULARIO N 4 REGIONAL O DIST) 2026--*/
    public function consolidado_formN4($dep_id,$dist_id,$tp_id){
      $tabla='';
      $tabla.='
          ...
          <table border="1" cellpadding="0" cellspacing="0" class="tabla">
              <thead>
                <tr style="background-color: #66b2e8">
                  ...
                  <th style="width:3%;background-color: #eceaea;">ID</th>
                  ...
                  <th style="width:3%;background-color: #eceaea;">COM ID</th>
            ...
            $tabla.='<tr>';
                ...
                $tabla.='<td bgcolor="#e4f3dc" align=center><b>'.$row['com_id'].'</b></td>';
