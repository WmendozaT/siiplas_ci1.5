...
class Model_resumenactividad extends CI_Model{
    ...
    public function resumen_actividad_objetivo_gestion_regional($dep_id){
        $sql = 'select og.og_codigo,og.og_objetivo, count(pr) actividades
                ...
                where poa.dep_id='.$dep_id.' and apg.aper_gestion='.$this->gestion.' and apg.aper_asignado=\'1\' and pr.estado!=\'3\'
                group by og.og_codigo,og.og_objetivo
                order by og.og_codigo asc';
    ...
    /*---- GET DATOS DE RESUMEN NRO DE ACTIVIDAD POR CATEGORIA PROGRAMATICA vigente ----*/
    ...
    /*---- GET DATOS DE RESUMEN NRO DE ACTIVIDAD POR CATEGORIA PROGRAMATICA - REGIONAL vigente ----*/
