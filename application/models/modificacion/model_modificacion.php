<?php
//// Model para el listado, historial de las modificaciones poa de form4 y form5
class Model_modificacion extends CI_Model{
    ...
    //// lista hitorial de modificacion poa form 5 x UnidadOrganizacional
    function get_lista_historial_modPoa_formN5_UnidadOrganizacional($proy_id){
        $sql = "SELECT *
                from fn_lista_poa_nacional_sp($this->gestion) poa
                Inner Join fn_historial_modificaciones_poa_form5($proy_id,$this->gestion) as h On h.proy_id=poa.proy_id" ;
...
/*    public function actividades_modificados($ope_id){
   ...
   //  }
    ...
    /*----- Lista de Cites Techo 2027 (VIGENTE) -------*/
