...
class Cevaluacion_form2 extends CI_Controller {
  ...
  public function reporte_form2($dep_id){
    ...
    $data['cabecera']=$this->eval_oregional->cabecera_form2($regional,0);
    $data['oregional']=$this->eval_oregional->det_rep_form2($dep_id);
    $data['pie']=$this->eval_oregional->pie_form2($regional);
    $data['cuadro_consolidado']=false;
    $data['titulo_pie']='DETALLE_FORM2_'.$regional[0]['dep_departamento'].'_'.$this->gestion.'';
  ...
  public function reporte_evaluacion_form2($dep_id){
    $regional=$this->model_proyecto->get_departamento($dep_id);
    $data['mes'] = $this->eval_oregional->mes_nombre();
    $data['cabecera']=$this->eval_oregional->cabecera_form2($regional,1);
