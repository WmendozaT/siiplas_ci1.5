        ...
        <div class="row">
          ...
          <div class="col-sm-2">
            <div class="well well-sm bg-color-darken txt-color-white text-center">
              ...
              <a href="'.site_url("").'/rep/exportar_form5_institucional/1" target=_blank title="EXPORTAR FORM. N 5 - INVERSIÓN"><img src="'.base_url().'assets/Iconos/page_excel.png" WIDTH="30px" HEIGHT="30px"/></a>
              <a href="'.site_url("").'/rep/exportar_form5_institucional/4" target=_blank title="EXPORTAR FORM. N 5 - GASTO CORRIENTE"><img src="'.base_url().'assets/Iconos/page_excel.png" WIDTH="30px" HEIGHT="30px"/></a>
            </div>
          </div>
          ...
          <div class="col-sm-2">
            <div class="well well-sm bg-color-teal txt-color-white text-center">
              ...
              <a href="'.base_url().'assets/video/ppto_asignado_aprobado'.$this->gestion.'.xlsx" download target=_blank title="DETALLE PPTO POR PARTIDA INSTITUCIONAL"><img src="'.base_url().'assets/Iconos/page_excel.png" WIDTH="30px" HEIGHT="30px"/></a>
            </div>
          </div>
