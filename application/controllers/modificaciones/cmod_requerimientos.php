...
//     }*/
    ...
    /*----- REPORTE REVSERSION DE SALDOS POR CERTIFICACION POA -------*/
    public function reporte_techo($cppto_id){
      ...
      if(count($cite)!=0){
        ...
        if($cite[0]['tp']==0){ //// modificacion del techo
  ...
  //// Detalle de Reversion de saldos x certificacion poa
 ...
 /*--------- REPORTE MODIFICACION TECHO (lista de cites por unidad organizacional)---------*/
