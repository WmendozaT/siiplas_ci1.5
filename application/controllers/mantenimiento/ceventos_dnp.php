...
////--------------------------
    public function certificado_fr(){
      //$get_participante=$this->model_evento->get_participante($ci_id);
      //if(count($get_participante)!=0 & $get_participante[0]['estado']==1){
          $data['pie_reporte']='CERT-DNP-FFMT9973500';
          $data['certificado']='';
          $data['certificado'].='
            <page backcolor="#004640" backleft="5mm" backright="5mm" backtop="5mm" backbottom="5mm" >
            <table style="width: 99%;" border="0">
              <tr>
                  <td style="width: 20%; height: 98%; background: #004640;">
                      ...
                      <div style="width: 100%; height:15%; text-align: center; color: white;">
                          <b>DNP - FFMT9973500</b><br>
                          <qrcode value="https://planificacion.cns.gob.bo/index.php/certificado_fr" ec="H" style="width: 40mm;"></qrcode><br>
                          DNP@siiplas
                      </div>
                  </td>
                  <td style="width: 80%; height: 98%; background: #FFFFFF; border: 0px;">
                      ...
                      <div style="width: 100%; height:15%;border:0px;">
                          <div style="font-size: 38px;font-family: Arial; color: #015045;text-align:center;"><b>CAJA NACIONAL DE SALUD</b></div>
                          <div style="font-size: 30px;font-family: Arial; text-align:center;"><b>OFICINA NACIONAL</b></div>
                          <div style="font-size: 18px;font-family: Arial; text-align:center;">DEPARTAMENTO NACIONAL DE PLANIFICACIÓN</div>
                      </div>
                      <!--  End Cabecera   -->
                      ...
                      <div style="width: 100%; height:45%;border:0px;">
                          <table style="width: 100%; height:20%;border:0px;">
                              <tr><td style="width: 31%; text-align:right;font-size: 17px;font-family: Arial;">Confiere el siguiente:</td>
                                  <td style="width: 69%;"></td>
                              </tr>
                          </table>
                          <br>
                          <div style="width: 100%; height:15%;border:0px; text-align: center;font-size: 40px;font-family: Arial;">
                              <b>CERTIFICADO DE PASANTIA</b>
                          </div>
                          <br>

                          <table style="width: 100%; height:10%;border:0px;">
                              <tr><td style="width: 14%; text-align:right;font-size: 18px;font-family: Arial;">Al señor:</td>
                                  <td style="width: 8%;"></td>
                                  <td style="width: 73%;font-size: 21px;font-family: Arial;"><b>FRANZ FREDDY MENDOZA TRUJILLO</b></td>
                              </tr>
                          </table>
                          <br>
                          <table style="width: 100%; height:10%;border:0px;" border="0">
                              <tr><td style="width: 90%;font-size: 15px;font-family: Arial;">&nbsp;&nbsp;&nbsp;por realizar sus prácticas pre profesionales de manera satisfactoria en el:</td></tr>
                              <tr>   
                                  <td style="width: 53%;font-size: 20px;font-family: Arial; text-align:center"> <br><b>CIMFA POLICLINICO VIACHA</b></td>
                              </tr>
                          </table>
                          <br>
                          <table style="width: 100%; height:20%;text-align: justify;" border="0">
                              <tr>
                                <td style="width: 80%;font-size: 15px;font-family: Arial;">&nbsp;&nbsp;&nbsp;desempeñando las siguientes funciones</td>
                              </tr>
                              <tr>
                                  <td style="width: 80%;font-size: 15px;font-family: Arial;">
                                        <ul style="list-style-type: square;">
                                            <li>Elaboración y seguimiento del Plan Operativo Anual (POA)</li>
                                            <li>Reorganización y sistematización de documentos institucionales</li>
                                            <li>Clasificación y catalogación de archivos</li>
                                        </ul>
                                  </td>
                              </tr>
                          </table>
                          ...
                          <table style="width: 100%;" border="0">
                              <tr><td style="width: 75%;"></td>
                                  <td style="width: 25%;font-family: Arial;">La paz 31 de junio de 2024</td>
                              </tr>
                          </table>
                      </div>
                      <!--  End Cuerpo   -->
