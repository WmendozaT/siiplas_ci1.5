          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="<?php echo base_url(); ?>assets/video/FORMULARIOS_APROY2026/Plan_de_Trabajo_y_Directrices_Formulacion_POA_2026.pdf" style="cursor: pointer;" download><b>1.- Plan de Trabajo y Directrices Formulacion poa 2026</b></a></li>
                <li><a href="<?php echo base_url(); ?>assets/video/FORMULARIOS_APROY2026/ACCIONES_DE_CORTO_PLAZO_POA_2026.pdf" style="cursor: pointer;" download><b>2.- Acciones de Corto Plazo 2026</b></a></li>
                <li><a href="<?php echo base_url(); ?>assets/video/FORMULARIOS_APROY2026/PLANTILLA_ACTIVIDADES_FINAL_GSS_2026.xlsx" style="cursor: pointer;" download><b>3.- Directrices Plantilla de Actividades Salud 2026</b></a></li>
                <li><a href="<?php echo base_url(); ?>assets/video/FORMULARIOS_APROY2026/FORM_POA_N°3_PROBLEMAS_Y_CAUSAS_2026.xlsx" style="cursor: pointer;" download><b>4.- Formulario SPO N° 3 - FODA 2026</b></a></li>
                <li><a href="<?php echo base_url(); ?>assets/video/FORMULARIOS_APROY2026/FORM_POA_N°4_ACTIVIDADES_2026.xlsx" style="cursor: pointer;" download><b>5.- Formulario SPO N° 4 - ACTIVIDADES 2026</b></a></li>
                <li><a href="<?php echo base_url(); ?>assets/video/FORMULARIOS_APROY2026/FORM_POA_N°5_PROG_FISICO_FINANCIERA_2026.xlsx" style="cursor: pointer;" download><b>6.- Formulario SPO N° 5 - REQUERIMIENTOS 2026</b></a></li>
                <li><a href="<?php echo base_url(); ?>assets/video/FORMULARIOS_APROY2026/MANUAL_DE_REGISTRO_DE_FORMULARIO_SPO_N3.pdf" style="cursor: pointer;" download><b>7.- Manual de Usuario Registro Formulario N° 3 FODA</b></a></li>


                <li class="divider"></li>
                <div style="color:blue; text-align: center;"><b>FORMULARIOS POA 2025</b></div>
                <li><a href="<?php echo base_url(); ?>assets/video/FORM_MOD_4_Y_5_2025.xlsx" style="cursor: pointer;" download>Descargar Formulario de Modificacion POA 2025</a></li>
                <li><a href="<?php echo base_url(); ?>assets/video/FORM_SOL_POA_5_2025.xlsx" style="cursor: pointer;" download>Descargar Formulario de Certificacion POA 2025</a></li>
                <li><a href="<?php echo base_url(); ?>assets/video/FORM_JUST_EDICION_CPOAS_2025.docx" style="cursor: pointer;" download>Descargar Formulario de Edicion de Cert. POA 2025</a></li>
                <li><a href="<?php echo base_url(); ?>assets/video/FORM_JUST_SALDOS_CPOAS_2025.docx" style="cursor: pointer;" download>Descargar Formulario de Reversion de Saldos POA 2025</a></li>
                
                <li class="divider"></li>
                <li class="dropdown-header">Archivos/Manuales</li>
                <li><a href="<?php echo base_url(); ?>assets/video/MANUALES_USUARIO/MANUAL_ACTUALIZACION_DE_CREDENCIALES_SIIPLAS.pdf" style="cursor: pointer;" download>Manual Actualización de Credenciales</a></li>
                <li><a href="<?php echo base_url(); ?>assets/video/MANUALES_USUARIO/MANUAL_REVERSION_DE_SALDOS_DISPONIBLES.pdf" style="cursor: pointer;" download>Manual de Reversion de Saldos</a></li>
                <li><a href="<?php echo base_url(); ?>assets/video/MANUALES_USUARIO/MANUAL_DE_USUARIO_REGISTRO_DE_REQUERIMIENTOS_E_IMPRESION_POA.pdf" style="cursor: pointer;" download>Manual de Impresion POA</a></li>
              </ul>
            </li>
          </ul>
