                        ...
                        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="well well-sm well-light">
                                <div id="tabs">
                                    ...
                                    <div id="tabs-c">
                                        <div class="row">
                                            <!-- <a href="<?php echo site_url("").'/mnt/xles_partidas/4';?>" title="EXPORTAR CUADRO COMPARATIVO" class="btn btn-success" style="width:15.5%;">EXPORTAR CUADRO (.XLS)</a><br><br> -->
                                            <div class="dropdown">
                                                <button class="btn btn-success dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-expanded="true" style="width:15.5%;">
                                                  REGIONALES
                                                ...
                                                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                                    <?php
                                                        foreach($regionales  as $row){ ?>
                                                            <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url().'index.php/mnt/xles_partidas/'.$row['dep_id'].'/4';?>" target="_blank"><?php echo $row['dep_departamento'];?></a></li>
                                                            <?php
                                                        }
                                                    ?>
                                                </ul>
            ...
            <div class="modal-dialog" id="csv">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h2><center>SUBIR ARCHIVO PPTO FINAL.CSV</center></h2>
