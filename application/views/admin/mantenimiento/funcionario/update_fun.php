                                ...
                                <div>
                                    ...
                                    <div class="widget-body no-padding">
                                        <form action="<?php echo site_url("admin").'/funcionario/add_update_fun' ?>" method="post" id="resp_form" name="resp_form" class="smart-form">
                                            ...
                                            <input type="text" name="sw" id="sw" value="<?php echo $fun[0]['sw_pass']?>">
                                                ...
                                                <div class="well">
                                                    <div class="row">
                                                        ...
                                                        <section class="col col-3">
                                                            ...
                                                            <input class="form-control" type="text" name="usuario" id="usuario" placeholder="Usuario" value="<?php echo $fun[0]['fun_usuario']?>" style="width:100%;" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" maxlength="25">
                                                        </section>
                                                        <section class="col col-3">
                                                            <label class="label"><font color="blue">PASSWORD</font></label>
                                                            <input class="form-control" type="text" name="password" id="password" placeholder="Password" value="<?php echo $edit_pass ?>" maxlength="30">
                                                        </section>
                                                    </div>    
                                                </div><br>
