...
<!--   <center><h1>LINK CERTIFICADO</h1></center>
  ...
  <center><h1>MATRIZ DE SEGUIMIENTO RD</h1></center>
  <ul class="menu">
    <li><a href="<?php echo base_url(); ?>assets/video/RD_2024_Y_2025.xlsx" download  title="FORMULARIO 3 "><b>1.- </b>MATRIZ DE SEGUIMIENTO A RESOLUCIONES DE DIRECTORIO</a></li>
  </ul>

  <center><h1>FORMULARIOS ANTE PROYECTO POA 2026</h1></center>
  <ul class="menu">
    ...
    <li><a href="<?php echo base_url(); ?>assets/video/FORMULARIOS APROY2025/FORM_POA_N°5_PROG_FISICO_FINANCIERA2026.xlsx" download  title="FORMULARIO 5 REQUERIMIENTOS"><b>3.- </b>FORMULARIO N° 5 - (Requerimientos)</a></li>
  </ul>

  <center><h1>FORMULARIOS EDICI&Oacute;N POA 2025</h1></center>
  <ul class="menu">
    <li><a href="<?php echo base_url(); ?>assets/video/FORM_SOL_POA_5_2025.xlsx" download  title="FORMULARIO DE SOLICITUD DE CERTIFICACIÓN POA"><b>1.- </b>FORMATO DE SOLICITUD DE CERTIFICACI&Oacute;N POA</a></li>
    <li><a href="<?php echo base_url(); ?>assets/video/FORM_MOD_4_Y_5_2025.xlsx" download  title="FORMULARIO DE SOLICITUD DE MODIFICACION POA - ACTIVIDADES Y REQUERIMIENTOS"><b>2.- </b>FORMATO DE SOLICITUD DE MODIFICACI&Oacute;N POA</a></li>
    <li><a href="<?php echo base_url(); ?>assets/video/FORM_JUST_EDICION_CPOAS.xlsx" download  title="FORMULARIO DE SOLICITUD DE MODIFICACION DE CERTIFICACION POA"><b>3.- </b>FORMATO DE SOLICITUD DE MODIFICACI&Oacute;N DE CERTIFICACION POA</a></li>
    <li><a href="<?php echo base_url(); ?>assets/video/FORM_JUST_SALDOS_CPOAS.xlsx" download  title="FORMULARIO DE SOLICITUD DE REVERSION DE SALDOS"><b>4.- </b>FORMATO DE SOLICITUD DE REVERSIÓN DE SALDOS</a></li>
  </ul>
...
<div id="contenido">
<a id="abrir" class="abrir-cerrar" href="javascript:void(0)" onclick="mostrar()"><b>ABRIR LISTA ARCHIVOS POA 2025</b></a><a id="cerrar" class="abrir-cerrar" onclick="ocultar()">CERRAR LISTA</a>
  <div class="container">
